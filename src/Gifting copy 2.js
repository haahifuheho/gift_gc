...
//    const [contract, setContract] = useState(null);
    ...
    const [contractAddress, setContractAddress] = useState("0x2e7292d31c9439122ae7c8f54a145f5f446c8a18");
    const handleOptionChange = (event) => {
        setSelectedOption(event.target.value);
        if (event.target.value === 'option1') {
            setContractAddress("0x2e7292d31c9439122ae7c8f54a145f5f446c8a18");
        } else if (event.target.value === 'option2') {
            setContractAddress("0x30bb48131b7bd9f39eb85093118a79591cbdf0fc");
        } 
    }
    const [contract, setContract] = useState(null);
...
//    setSelectedOption(event.target.value);
//    if (event.target.value === 'option1') {
//        const contractAddress = "0x2e7292d31c9439122ae7c8f54a145f5f446c8a18";
//      } else if (event.target.value === 'option2') {
//        const contractAddress = "0x30bb48131b7bd9f39eb85093118a79591cbdf0fc";
